...
(function ($, window) {
  ...
  Tour = (function () {
    ...
    Tour.prototype.hideStep = function (i) {
      var hideStepHelper; var promise; var step
      var _this = this
      step = this.getStep(i)
      if (!step) {
        return
    ...
    Tour.prototype.showStep = function (i) {
      var promise; var showStepHelper; var skipToPrevious; var step
      var _this = this
      step = this.getStep(i)
      if (!step) {
        return
    ...
    Tour.prototype._showNextStep = function () {
      var promise; var showNextStepHelper; var step
      var _this = this
      step = this.getStep(this._current)
    ...
    Tour.prototype._showPrevStep = function () {
      var promise; var showPrevStepHelper; var step
      var _this = this
      step = this.getStep(this._current)
    ...
    Tour.prototype._showPopover = function (step, i) {
      var $element; var $navigation; var $template; var $tip; var isOrphan; var options
      var _this = this
    ...
    Tour.prototype._scrollIntoView = function (element, callback) {
      var $element; var $window; var counter; var offsetTop; var scrollTop; var windowHeight
      var _this = this
      $element = $(element)
      if (!$element.length) {
        return callback()
